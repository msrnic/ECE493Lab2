...
* **2b**: Reviewer has conflict of interest  
  * **2b1**: System blocks assignment for conflicted reviewer
  * **2b2**: Editor selects non-conflicted alternate reviewer
* **3a**: Concurrent assignment confirmation conflict  
  * **3a1**: System accepts first confirmation and rejects stale confirmation with reload guidance
