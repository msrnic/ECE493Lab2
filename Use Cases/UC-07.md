...
* **1a**: Notification delivery failure  
  * **1a1**: System retries
* **1b**: Notification delivery repeatedly fails  
  * **1b1**: System retries every 5 minutes up to 3 retries
  * **1b2**: System marks invitation failed, logs details, keeps reviewer assignment active, and flags follow-up
